-- Revert the atomic cubby extension changes and restore the previous working version

-- Drop the current problematic function
DROP FUNCTION IF EXISTS extend_cubby_rental;

-- Restore the previous working version of the function
...
-- Ensure the check_cubby_extension_availability function is properly defined
...
-- Fix the realtime publication to include all necessary tables
DROP PUBLICATION IF EXISTS supabase_realtime;
CREATE PUBLICATION supabase_realtime FOR TABLE cubby_rentals, cubbies, notifications;
